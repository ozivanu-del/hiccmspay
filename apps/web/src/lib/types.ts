...
export type Child = { id: string; nis: string; name: string; photo?: string; class: string; educationLevel: string; room?: string; balance: number; cardNumber: string }
...
export type Card = { card_id: string; card_number: string; card_status: string; student_id: string; nis: string; student_name: string; photo?: string; class: string; education_level?: string; wallet_id: string; balance: number; parent_name?: string; scanSessionId: string }
