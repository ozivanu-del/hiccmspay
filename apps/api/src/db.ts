...
export type CardWalletRow = { card_id: string; card_number: string; card_status: string; student_id: string; nis: string; student_name: string; photo: string | null; class: string; wallet_id: string; balance: number; parent_name?: string | null }
